...
docker run -dit --name spark-master --network spark-net -p 8080:8080 master bash
...
docker run -it --rm --privileged --cpus="2" --network spark-net basestation # run this in multiple terminals to run many basestations
